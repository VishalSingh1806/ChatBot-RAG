...
def process_folder_pdfs(folder_path, collection_name="epr_docs"):
    ...
    if all_chunks:
        ...
        print(f"Stored {len(all_chunks)} chunks from {len(pdf_files)} PDFs in chroma_db1/{collection_name}")
...
if __name__ == "__main__":
    ...
    print(f"Processing PDFs into chroma_db1 from: {folder_path}")
    process_folder_pdfs(folder_path, collection_name="epr_docs")
