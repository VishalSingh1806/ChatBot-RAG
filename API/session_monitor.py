    ...
    while True:
        try:
            ...
            for key in session_keys:
                ...
                if ":chat" in key_str or ":finalized" in key_str or ":thankyou_sent" in key_str or ":monitor_inactivity" in key_str or ":backend_sent" in key_str or ":suggestions" in key_str:
                    continue
