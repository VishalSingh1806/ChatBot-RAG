...
def refine_with_gemini(
    ...
    prompt_text = (
        ...
        '7. Keep answers concise - 3-5 sentences or 3-5 bullet points maximum\n'
        '8. Do NOT assume user\'s business type or add phrases like "brands like yours"\n'
        '9. Do NOT add contact information - it will be added separately when needed\n'
        '10. For multiple dates/options: Present the most recent or relevant one first\n'
        '11. Use professional language - avoid casual phrases\n'
        '12. SCOPE: Only answer EPR, plastic waste, and ReCircle topics\n'
